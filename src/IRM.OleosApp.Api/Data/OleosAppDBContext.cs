...
{
    public class OleosAppDBContext : DbContext
    {
        public OleosAppDBContext() : base("OleosAppDBConnectionString")
        {
            Database.SetInitializer<OleosAppDBContext>(new CreateDatabaseIfNotExists<OleosAppDBContext>());
            //Database.SetInitializer(new OleosAppDBInitializer());
        }
